...
function AnchorJS(a) {
    ...
    this.options = a || {},
        ...
        this.add = function(a) {
            ...
            if (this._applyRemainingDefaultOptions(this.options),
                    a) {
                if ("string" != typeof a)
                    throw new Error("The selector provided to AnchorJS was invalid.")
            } else
                a = "h1, h2, h3, h4, h5, h6";
            if (b = document.querySelectorAll(a),
                0 === b.length)
                return !1;
            for (this._addBaselineStyles(),
                     c = document.querySelectorAll("[id]"),
                     d = [].map.call(c, function(a) {
                         return a.id
                     }),
                     f = 0; f < b.length; f++) {
                ...
                "&#xe9cb" === this.options.icon && (o[0].style.fontFamily = "anchorjs-icons",
                    o[0].style.fontStyle = "normal",
                    o[0].style.fontVariant = "normal",
                    o[0].style.fontWeight = "normal"),
                    "left" === this.options.placement ? (o[0].style.position = "absolute",
                        o[0].style.marginLeft = "-1em",
                        o[0].style.paddingRight = "0.5em",
                        b[f].insertBefore(o[0], b[f].firstChild)) : (o[0].style.paddingLeft = "0.375em",
                        b[f].appendChild(o[0]))
            }
            return this
        }
        ...
        this.remove = function(a) {
            for (var b, c = document.querySelectorAll(a), d = 0; d < c.length; d++)
                b = c[d].querySelector(".anchorjs-link"),
                b && c[d].removeChild(b);
            return this
        }
        ,
...
!function(a, b) {
    ...
    !function(a) {
        ...
        var d, e = {
                ...
                var d, e, f;
                return a.getComputedStyle ? d = a.getComputedStyle(b, null ).getPropertyValue(c) : (e = n(c),
                    d = b.currentStyle ? b.currentStyle[e] : b.style[e]),
                    "cursor" !== c || d && "auto" !== d || (f = b.tagName.toLowerCase(),
                    "a" !== f) ? d : "pointer"
            }
            , p = function(b) {
                b || (b = a.event);
            ...
            , v = function(b, c) {
                ...
                if (b.getBoundingClientRect) {
                    ...
                    "pageXOffset" in a && "pageYOffset" in a ? (e = a.pageXOffset,
                        f = a.pageYOffset) : (g = u(),
            ...
            , x = function(b) {
                var c, d, e, f = [], g = [], h = [];
                if (b.trustedOrigins && ("string" == typeof b.trustedOrigins ? g.push(b.trustedOrigins) : "object" == typeof b.trustedOrigins && "length" in b.trustedOrigins && (g = g.concat(b.trustedOrigins))),
                    b.trustedDomains && ("string" == typeof b.trustedDomains ? g.push(b.trustedDomains) : "object" == typeof b.trustedDomains && "length" in b.trustedDomains && (g = g.concat(b.trustedDomains))),
                        g.length)
                    for (c = 0,
                             d = g.length; d > c; c++)
            ...
            , y = function(a, b, c) {
                ...
                var d, e = b.length;
                for ("undefined" == typeof c ? c = 0 : 0 > c && (c = e + c),
                         d = c; e > d; d++)
            ...
            , F = function() {
                var a = function(a, b) {
                    var c, d, e;
                    if (null  != a && "*" !== b[0] && ("string" == typeof a && (a = [a]),
            ...
            , K = function(a, b) {
                return this instanceof K ? (this.id = "" + g++,
                    h[this.id] = {
                        instance: this,
                        elements: [],
                        handlers: {}
                ...
                a && this.clip(a),
                "undefined" != typeof b && (C("new ZeroClipboard(elements, options)", N.debug),
                    K.config(b)),
                    this.options = K.config(),
                "boolean" != typeof e.disabled && (e.disabled = !J()),
                    void (e.disabled === !1 && e.outdated !== !0 && null  === e.bridge && (e.outdated = !1,
                        e.ready = !1,
                        O()))) : new K(a,b)
            }
            ;
        K.prototype.setText = function(a) {
            return a && "" !== a && (f["text/plain"] = a,
        ...
        K.config = function(a) {
            if ("object" == typeof a && null  !== a && D(N, a),
                "string" != typeof a || !a) {
                var b = {};
                for (var c in N)
        ...
        var R = function(b, c, d, e) {
                ...
                if (f && f.length) {
                    ...
                    for (g = 0,
                        ...
                        "object" == typeof j && j && "function" == typeof j.handleEvent && (c = j,
                            j = j.handleEvent),
        ...
        K.prototype.clip = function(a) {
            ...
            for (var b = 0; b < a.length; b++)
                if (a.hasOwnProperty(b) && a[b] && 1 === a[b].nodeType) {
                    a[b].zcClippingId ? -1 === y(this.id, j[a[b].zcClippingId]) && j[a[b].zcClippingId].push(this.id) : (a[b].zcClippingId = "zcClippingId_" + i++,
                        ...
                        if (a.hasOwnProperty(e) && a[e] && 1 === a[e].nodeType) {
                            ...
                            if (f) {
                                for (c = 0; -1 !== (c = y(this.id, f, c)); )
                                    f.splice(c, 1);
                                0 === f.length && (N.autoActivate === !0 && r(a[e], "mouseover", p),
        ...
        var S = function(a) {
                var b, c, d, e, f, g = [];
                if (a && 1 === a.nodeType && (b = a.zcClippingId) && j.hasOwnProperty(b) && (c = j[b],
                    c && c.length))
                    for (d = 0,
                             e = c.length; e > d; d++)
                        f = h[c[d]].instance,
        ...
        N.hoverClass = "zeroclipboard-is-hover",
            ...
            K.prototype.receiveEvent = function(a, b) {
                if (C("ZeroClipboard.prototype.receiveEvent", N.debug),
                    "string" == typeof a && a) {
                    var c = a.toLowerCase().replace(/^on/, "");
                    c && T.call(this, c, b)
                }
            ...
            K.prototype.setTitle = function(a) {
                if (C("ZeroClipboard.prototype.setTitle", N.debug),
                        a = a || N.title || d && d.getAttribute("title")) {
                    var b = P(e.bridge);
        ...
        "function" == typeof define && define.amd ? define(["require", "exports", "module"], function(a, b, c) {
            return k = c && c.id || null ,
                K
        }) : "object" == typeof module && module && "object" == typeof module.exports && module.exports && "function" == typeof a.require ? (l = module.id || null ,
            module.exports = K) : a.ZeroClipboard = K
    }(function() {
        return this
    }());
                ...
                localStorage.getItem("previewTheme") && d(),
                    c.click(function() {
                        ...
                        a && 0 !== a.indexOf("data") ? (b.attr("href", ""),
                            c.text("主题预览"),
                            localStorage.removeItem("previewTheme")) : d()
                    })
            }(),
